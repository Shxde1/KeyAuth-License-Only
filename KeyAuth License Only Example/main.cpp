...
/*
  try to find something to encrypt these even if you might encrypt after compilation time just encrypt them using xor even thought it can easily be decrypted
*/
...
int main()
{
	...
	std::cout << skCrypt("Add Your Loader Stuff Here");
